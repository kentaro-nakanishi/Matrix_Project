    ...
    while True:
        ...
        for pair in B_class:
            ...
            if pair[1] == 1:
                ...
                #print(["new_B_class1",new_B_class])
                ...
                if  hom(treeB, pair[0]):#treeBよりも小さいならば
                    ...
                    #print(["new_B_class2",new_B_class])
                    ...
                    #print(["new_B_class3",new_B_class])
...
def midinize(pitch_list,time_list,voice_list):
    ...
    for i in range(howmany_voice):#声部ごとに処理する。
        ...
        new_instrument =   pretty_midi.Instrument(program=3*i)  #instrumentsinstanceなるものを作成。
...
def main():#まずここが実行される。処理の全体像を記述せよ。
    ...
    #2進の木集合を生成する。
    tree = glowing_function(repeat=18,R_true_tree=R_true_tree,ref=ref)
